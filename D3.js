...
/*  for (let i = 0; i < starWarsCharacters.length; i++){
  characters.push (starWarsCharacters[i].nome)
...
while (i5 < starWarsCharacters.length) {
  crewMass += starWarsCharacters[i5].mass;
  i5++;
}

console.log("La somma delle masse di tutti i personaggi è: " + crewMass);  */
...
/* characters = characters.filter(character => !femaleCharacters.includes(character.nome));
